          ...
          <div key={item.id} className='grid grid-cols-1 gap-8 p-8 md:grid-cols-2 md:place-items-center '>
            ...
            <article>
              ...
              <ul className="text-sm text-slate-400 leading-loose lg:text-base lg:leading-relaxed">
                <li ><span className="font-bold text-slate-200">Bred For: </span>{" "}{item.bred_for}</li>
                <li><span className="font-bold text-slate-200">Height: </span>{" "}{item.height.metric}cm</li>
                <li><span className="font-bold text-slate-200">Weight: </span>{" "}{item.weight.metric}kg</li>
